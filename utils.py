...
def estimate_pi(numPoints: int, rng):
    """
...
def estimate_pi_sobol(numPoints:int,seed:None):
   """
...
def estimation(selected_points,rng,seed):
    """
    ...
    estimate_sobol,points = estimate_pi_sobol(selected_points,seed)
